...
import decoder from 'jwt-decode'
 ...
 class TodayEnquiry  extends React .Component{
     constructor(){
         super()
         this.state={
             todayEnquiry:[
     ...
     componentDidMount(){
       axios.get('/api/todayEnquiry/'+decoder(window.localStorage.getItem('superToken'))._id)
       .then(data=>{
         this.setState({todayEnquiry:data.data.todayEnquiry})
         console.log(data.data.todayEnquiry)
       })
       .catch(err=>{
         console.log(err)
       })
     }
     doneControler=(id, event)=>{
       event.preventDefault()
       axios.get('/api/doneApi/'+id)
       .then(data=>{
         console.log(data)
       })
     ...
     deleteClient=(id , event)=>{
       console.log('deleteing this client ')
       event.preventDefault()
                ...
                <div className="">
                    ...
                    <div className="card  pt-5 mt-5 pb-5 mb-5  ">
                      ...
                      <CardHeader className="border-bottom d-flex">
                        ...
                        <h2 className="text-center pt-5 mt-5 pb-5 mb-5 ">No  Enquiry For Today</h2>
                    </div>:
                <Row>
                  <Col>
                    <Card small className="mb-4">
                      ...
                      <CardBody className="p-0 pb-3">
                        <table className="table mb-0">
                          ...
                          <tbody>
                              {this.state.todayEnquiry.map(( singleItem, i) =>{
                                  return(
                                    ...
                                    <tr key={i}>
                                        ...
                                        <div class="dropdown">
                                                ...
                                                <a class="dropdown-item" href="#"  data-toggle="modal" data-target="#exampleModal" onClick={this.getData.bind(this , singleItem._id)} >Update</a>
                                                    ...
                                                    <Link to='' onClick={this.doneControler.bind(this , singleItem._id)} class="dropdown-item" href="#">Done</Link>
                                                </div>
                                                </div>
                                         </td>
                                    </tr>

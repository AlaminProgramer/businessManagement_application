...
import {ListGroup, ListGroupItem, Row, Col, Card, CardHeader, CardBody } from "shards-react";
import { Link } from 'react-router-dom';
import axios from 'axios'
import decoder from 'jwt-decode'

 class TodayFollowUp  extends React .Component{
     constructor(){
         super()
         this.state={
            todayFollowUp:[
     ...
     componentDidMount(){
      ...
      .then(data=>{
        this.setState({todayFollowUp:data.data.todayFollowUp})
        console.log(data.data.todayFollowUp)
      })
      .catch(err=>{
        console.log(err)
      })
        ...
        render(){
            ...
            return(
                ...
                <div className="">
                    ...
                    {this.state.todayFollowUp.length==0?
                    <div className="card  pt-5 mt-5 pb-5 mb-5  ">
                      
                        <CardHeader className="border-bottom d-flex">
                          <h3 className="m-0">Today's Followup</h3>
                        </CardHeader>
                        <h2 className="text-center pt-5 mt-5 pb-5 mb-5 ">No  Followup Founded For Today</h2>
                    </div>:
                <Row>
                  <Col>
                    <Card small className="mb-4">
                      ...
                      <CardBody className="p-0 pb-3">
                        <table className="table mb-0">
                          ...
                          <tbody>
                              {this.state.todayFollowUp.map(singleItem=>{
                                  return(
